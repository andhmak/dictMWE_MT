# Script parsing the human-generated fluency annotations comparing "unaided" and "aided" GPT translations, printing the relevant statistics

import json
 
# Open the file with the annotations
f = open('../data/english_fluency_annotations.json', encoding="utf8")
